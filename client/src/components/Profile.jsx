    ...
    <div class="bg-black border-b-2 border-[#283036]">
      ...
      {isPopupVisible && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50 ">
          <div className="bg-black p-6 rounded-lg shadow-lg w-full max-w-lg border-2 border-[#1D9BF0]">
            ...
            <div className="relative mb-4">
              ...
              />
              <button className="absolute bottom-2 right-2 bg-gray-200 text-gray-600 px-3 py-1 text-sm rounded-full">
                Edit Banner
              </button>
            </div>
            ...
            <div className="relative mb-4">
              <img
                src="./user.jpeg"
                alt="Profile Picture"
                className="w-24 h-24 rounded-full border-4 border-white -mt-12 mx-auto"
              />
              <button className="absolute top-16 left-2/4 transform -translate-x-1/2 bg-gray-200 text-gray-600 px-3 py-1 text-sm rounded-full">
                Edit Picture
              </button>
            </div>
